...
dispatch(WriteInsertion({[e.target.name]:e.target.value}))
  ...
  return (
    <div className="w-full">
      <Input placeholder="Title" name="title" className="   focus-visible:ring-0 border border-black my-2 text-2xl " onChange={(e)=>InputHandler(e)} value={writeState.title}/>
      <Input placeholder="Sub-title or teaser " name="subtitile" className="   focus-visible:ring-0 border border-black my-2 text-xl" onChange={(e)=>InputHandler(e)} value={writeState.subtitile} />
      <div className="flex gap-x-2 w-full justify-between" >
      <div className="w-[80%]">
      <Input placeholder="Topic i.e Programming or Entertaiment" name="topic" className=" outline-none  focus-visible:ring-0 border border-black my-2 text-md " onChange={(e)=>InputHandler(e)} value={writeState.topic}/>
